        ...
        <section className='c-space my-20'>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full'>
                ...
                <div className='border border-black-300 bg-black-200 rounded-lg h-96 md:h-full'>
                            ...
                            {/* Simulated Lightning */}
                            <pointLight position={[0, 5, -5]} intensity={50} color="white" />
                            <pointLight position={[-5, 5, -5]} intensity={40} color="blue" />
                            <pointLight position={[5, 5, -5]} intensity={40} color="purple" />

                                <Center/>
                                {/* <Suspense fallback={<CanvasLoader />}/> */}

                                <group scale={5} position={[1, -4, -1]} rotation={[0, 0, 0]}>
                                    <Anime />
                                </group>
